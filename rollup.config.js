...
export default [
  {
    input: 'src/index.ts',
    output: {
      name: 'Gamerig.Rendering.Threejs',
      file: 'dist/browser/gamerig.rendering.threejs.min.js',
      format: 'umd',
      sourcemap: !production,
      globals: {
        '@gamerig/core': 'Gamerig.Core',
        '@gamerig/threejs': 'Gamerig.Threejs',
        three: 'THREE',
      },
    },
    external: ['three', '@gamerig/core', '@gamerig/threejs'],
    plugins: [
      del({
        targets: ['./dist'],
        runOnce: !production,
